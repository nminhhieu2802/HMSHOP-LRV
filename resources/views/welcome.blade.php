...
<body class="antialiased">
    <div
        class="relative flex items-top justify-center min-h-screen bg-black-100 dark:bg-black-900 sm:items-center py-4 sm:pt-0">
        @if (Route::has('login'))
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
            <a href="{{ url('/home') }}" class="text-sm text-black-700 dark:text-black-500 underline">Home</a>
            @else
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <svg viewBox="0 0 651 192" fill="none" xmlns="http://www.w3.org/2000/svg"
                    class="h-16 w-auto text-black-700 sm:h-20">
            ...
            <div class="mt-8 bg-black dark:bg-black-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-black-500">
                                <path
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs"
                                    class="underline text-black-900 dark:text-black">Documentation</a></div>
                        </div>
                    ...
                    <div class="p-6 border-t border-black-200 dark:border-black-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-black-500">
                                <path
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laracasts.com"
                                    class="underline text-black-900 dark:text-black">Laracasts</a></div>
                        </div>
                    ...
                    <div class="p-6 border-t border-black-200 dark:border-black-700">
                        <div class="flex items-center">
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-black-500">
                                <path
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel-news.com/"
                                    class="underline text-black-900 dark:text-black">Laravel News</a></div>
                        </div>
                    ...
                    <div class="p-6 border-t border-black-200 dark:border-black-700 md:border-l">
                        <div class="flex items-center">
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-black-500">
                                <path
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold text-black-900 dark:text-black">Vibrant
                                Ecosystem</div>
                        </div>
                ...
                <div class="text-center text-sm text-black-500 sm:text-left">
                    <div class="flex items-center">
                        <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            viewBox="0 0 24 24" stroke="currentColor" class="-mt-px w-5 h-5 text-black-400">
                            <path
                        ...
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2" viewBox="0 0 24 24" class="ml-4 -mt-px w-5 h-5 text-black-400">
                            <path
